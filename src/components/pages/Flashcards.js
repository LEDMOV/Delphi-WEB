  ...
  return (
    <div className="text-center font-custom p-8">
      ...
      {fullscreenCard && (
        ...
        >
          <div className="bg-white p-8 shadow-lg rounded-lg max-w-lg w-full transform transition duration-300 hover:scale-105">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">{fullscreenCard.question}</h2>
            <p className="text-gray-600 mb-4">{fullscreenCard.answer}</p>
            <button
